...
export default function Course() {
  return (
    ...
    <div className='max-w-screen-2xl container x-auto md:px-20 px-4 '>
      <div className='mt-28 items-centre justify-content text-center'>
        ...
        <p className=' mt-12'>Welcome to the next level of your coding journey!
           ...
           future. So gear up, stay curious, and let’s build something incredible — one line at a time.</p>
           <Link to="/">
