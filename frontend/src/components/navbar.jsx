...
export default function navbar() {
  ...
  const navItems=(
    ...
    <li><a href='/'>Home</a>
      ...
      <li><a href='/technews'>Tech News</a>
      </li>
      <li>
  ...
  <div className="navbar-start">
    ...
    <a className=" text-2xl font-bold cursor-pointer">oneSTOP</a>
  </div>
...
<div className="hidden md:block  dark:bg-slate-900 dark:text-white "><input type="text" placeholder="Type here" className="input" /></div>
